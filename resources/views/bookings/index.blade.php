...
<div class="container">
  ...
  <div class="mt-4">
    <ul class="list-group list-group-horizontal">
      <li class="list-group-item list-group-item-action text-center col-4"><a href="{{ route('books.index') }}">貸出書籍</a>
      </li>
      <li class="list-group-item list-group-item-action text-center col-4"><a href="{{ route('users.index') }}">ユーザー</a>
      </li>
      <li class="list-group-item list-group-item-action text-center col-4"><a
          href="{{ route('bookings.index') }}">申請状況</a></li>
    </ul>
  </div>
    ...
    <div class="col-12 col-md-6 offset-md-6">
      <form action="{{ route('bookings.index') }}" method="GET">
        ...
        <div class="input-group mb-3">
          <input id="search-book-id" type="text" name="book_id" value="{{ $query['book_id'] }}" class="form-control"
            placeholder="書籍IDを入力してください" aria-describedby="button-search">
        </div>
        ...
        <div class="input-group-append">
          <button class="btn btn-md btn-outline-primary m-0 px-3 py-2 z-depth-0 waves-effect" type="submit"
            id="button-search">検索</button>
        </div>
      </form>
    </div>
  </div>
